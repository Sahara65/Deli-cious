...
public class ProgressBar {
    public static void main(String[] args) throws InterruptedException {
        ...
        final int loadTime = 200;

        // Looping through each step for updating animation
        for (int step = 0; totalSteps >= step; step++) {
    ...
    public static String createProgressBar(int completion) {
        ...
        // Creating progressbar by repeating the completed bars on top of
        // pre-determined length of uncompleted bars
